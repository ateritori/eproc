...
<header class="bg-dark text-white py-3 fixed-top shadow">
    <div class="container-fluid d-flex align-items-center">
        <img src="{{ asset('images/kemenhan.png') }}" alt="Logo Kemenhan" width="50" height="50" class="me-2">
    ...
    <div class="container content">
        <div class="sub-header border rounded bg-light d-flex justify-content-between align-items-center">
            ...
            <form method="GET" action="{{ route('dashboard') }}" class="d-flex">
                <input type="text" name="search" class="form-control me-2" placeholder="Cari pekerjaan..." value="{{ request('search') }}" style="width: 250px;">
        ...
        <div class="table-container">
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{ $loop->iteration + ($lelang->currentPage() - 1) * $lelang->perPage() }}</td>
